...
def generate_frames(cppn_net, img_res=128, num_frames=50):
    ...
    for frame_idx in range(num_frames):
        ...
        img = jnp.stack([output_values["r"], output_values["g"], output_values["b"]], axis=2)
...
def main(args):
    ...
    print(f"CPPN initialized with inputs {cppn.input_names} and outputs {cppn.output_names}")
